...
<head runat="server">
    <title><%= this.WebSiteShortName %> | Login</title>
    <style type="text/css">
...
<body>
    <form id="form1" runat="server" defaultfocus="Login1">
        ...
        <div id="centered" align="center">
            <asp:Image ID="LogoImage" runat="server" ImageUrl="~/Images/<%= this.WebSiteShortName %>-Website-Header.jpg" AlternateText="Logo" Height="192px" Width="345px" />
            <p></p>
            ...
            <asp:Login ID="_HydraLogin" runat="server" BackColor="#EEEEEE" BorderColor="#888888" BorderPadding="4"
                ...
                <TitleTextStyle BackColor="#006400" Font-Bold="True" Font-Size="0.9em" ForeColor="White" />
            ...
            If you are a <%= this.WebSiteShortName %> client and would like access to our tools,
            <br />
            please click <a href="mailto:shelly@sc-man?subject=New <%= this.WebSiteShortName %> web Account">here</a> to email Shelly Anthony.<br />
            <br />
            If you are experiencing technical problems with an existing account,<br />
            please click <a href="mailto:jorge@sc-man.com?subject=<%= this.WebSiteShortName %> web Service Issue">here</a> to email Jorge Sandoval.<br />
            <br />
        </div>
