...
namespace Scm.OpsCore.Legacy.NHibernate
{
    ...
    internal class NHibernateSessionFactory
    {
        ...
        /// <summary>
        /// Maintains a connection string for the session factory.
        /// </summary>
        private readonly string _connectionString;
        /// <summary>
        /// Manages individual connection string details if needed.
        /// </summary>
        ...
        {
            var connectionString = _connectionString ?? _connection.CreateConnectionString();
