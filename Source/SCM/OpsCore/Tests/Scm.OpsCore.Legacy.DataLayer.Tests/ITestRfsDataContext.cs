namespace Scm.OpsCore.Legacy.DataLayer.Tests
{
    ...
    public interface ITestRfsDataContext
    {
        ...
        void TestGetServiceOfferedById(IRfsDataContext context);
        void TestGetServicesOfferedByIds(IRfsDataContext context);
        void TestGetServiceOfferedByServiceRequestedId(IRfsDataContext context);
        ...
        void TestGetCompanyUsers(IRfsDataContext context);
        void TestGetCompanies(IRfsDataContext context);
        void TestGetCompanyUserPermissions(IRfsDataContext context);
