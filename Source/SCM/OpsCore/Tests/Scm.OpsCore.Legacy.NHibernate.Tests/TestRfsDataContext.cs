...
namespace Scm.OpsCore.Legacy.NHibernate.Tests
{
    ...
    public class TestRfsDataContext
    {
        ...
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetCalculationResultsByShipperId()
        {
        ...
        /// <summary>
        /// Ensures services offered may be retrieved by ID.
        /// </summary>
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetServiceOfferedById()
        {
            _tester.TestGetServiceOfferedById(_context);
        }
        ...
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetServicesOfferedByIds()
        {
            _tester.TestGetServicesOfferedByIds(_context);
        }
        ...
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetServiceOfferedByServiceRequestedId()
        {
            _tester.TestGetServiceOfferedByServiceRequestedId(_context);
        }
        ...
        /// <summary>
        /// Ensures companies may be retrieved.
        /// </summary>
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetCompanies()
        {
            _tester.TestGetCompanies(_context);
        }

        /// <summary>
        /// Ensures company users may be retrieved.
        /// </summary>
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetCompanyUsers()
        {
            _tester.TestGetCompanyUsers(_context);
        }

        /// <summary>
        /// Ensures company user permissions may be retrieved.
        /// </summary>
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetCompanyUserPermissions()
        {
            _tester.TestGetCompanyUserPermissions(_context);
        }

        /// <summary>
        /// Ensures fuel surcharge data may be retrieved.
        /// </summary>
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetFuelSurcharge()
        {
            _tester.TestGetFuelSurcharge(_context);
        }

        /// <summary>
        /// Ensures fuel surcharge data may be retrieved by ID.
        /// </summary>
        [Test]
        [Category("DatabaseRequired")]
        public void TestGetFuelSurchargeById()
        {
            _tester.TestGetFuelSurchargeById(_context);
        }

        [Test]
        [Category("DatabaseRequired")]
        public void TestGetScansByDocumentIdsSignedAndReject()
        {
