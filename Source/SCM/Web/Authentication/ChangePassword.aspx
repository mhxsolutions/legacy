<%@ Page Title="" Language="C#" MasterPageFile="~/SCM.master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="Web.Authentication.ChangePassword" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ShowCollapseButton="false" HeaderText="Change Password" Width="450" Theme="Office2010Blue">
        <PanelCollection>
