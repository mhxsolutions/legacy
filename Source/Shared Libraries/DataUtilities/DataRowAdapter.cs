...
{
    /// <summary>
    /// Wraps an IDataRecord interface around the supplied DataRow. Useful for using a consistent
    /// set of functions to extract data from DataRow objects and SqlDataReader objects.
    /// </summary>
