<%@ Page Title="" Language="C#" MasterPageFile="~/CopsWeb.master" AutoEventWireup="true" CodeBehind="BudwayUsers.aspx.cs" Inherits="Web_App.Administration.BudwayUsers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
    <h2>Budway Users</h2>

    <p>
        The following are the known Budway users of this site. Click the user ID to make changes.
    </p>
