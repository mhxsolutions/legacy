<%@ Page Language="C#" MasterPageFile="~/BopsWeb.master" AutoEventWireup="true" 
    Inherits="RFS_RfsWizardRequestAssessorial" Title="BOPS | RFS Wizard | Assessorial" Codebehind="RfsWizardRequestAssessorial.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="z-index: 103; left: 0px; width: 1000px; top: 10px;">
        ...
        <h2><% Response.Write(Request.QueryString["mode"]); %> Assessorial Service <% Response.Write(Request.QueryString["ServiceId"]); %></h2>
        <p>
        ...
        <div style="z-index: 105; left: 20px; position: relative">
            <table cellpadding="4">
                <tr class="header"><td colspan="2">Assessorial Details</td></tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td style="width: 400px">
                        <asp:DropDownList ID="ServicesList" runat="server" DataSourceID="ServiceList" DataTextField="Name"
                            ...
                            <SelectParameters>
                                <asp:Parameter DefaultValue="3" Name="Service_Category_Ref" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </td>
                </tr>
