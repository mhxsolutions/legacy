...
public partial class Inventory_BisTransactionHistoryNEW : System.Web.UI.Page
{
    protected void Page_Load(object Sender, EventArgs E)
    {
        if (IsPostBack) return;
        _HistoryGridviewNEW.SortBy(_HistoryGridviewNEW.Columns["Tx Id"], DevExpress.Data.ColumnSortOrder.Ascending);
    ...
    {
        Response.Redirect("BisTransactionHistoryNEW.aspx");
    }
}
