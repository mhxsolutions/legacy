<%@ Page Language="C#" MasterPageFile="~/BopsWeb.master" AutoEventWireup="true" Inherits="Planning_DriverPlannerCreateStep" 
    Title="BOPS | Planning | Create Driver Plan Step" Codebehind="DriverPlannerCreateStep.aspx.cs" %>
    
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <h2>Create Driver Plan Step</h2>
    <h3><asp:Label ID="_PlanHeaderLabel" runat="server" /></h3>
    <p>To create a new driver plan step, provide the required information and click the "Create" button.</p>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource
                    ...
                    SelectCommand="SELECT tblPoscoLoads.[Load] FROM tblPoscoLoads LEFT OUTER JOIN [Planner Detail] ON tblPoscoLoads.[Load] = [Planner Detail].[Load Ref] WHERE (tblPoscoLoads.LogOutDate IS NULL) AND (tblPoscoLoads.LoadDate <= GETDATE()) AND ([Planner Detail].[Load Ref] IS NULL)">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
