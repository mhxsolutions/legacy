...
public partial class Monitoring_DriversNearHarbor_Mobile320x320 : Page
{
    private static readonly ILog _Log = LogManager.GetLogger(typeof(Monitoring_DriversNearHarbor_Mobile320x320));
    ...
    private LatestDriverPosition GetLatestDriverPositionFromReader(IDataRecord Reader)
    {
