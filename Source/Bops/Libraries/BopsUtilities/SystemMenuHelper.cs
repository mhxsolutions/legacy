...
namespace BopsUtilities
{
    ...
    /// </summary>
    /// <remarks>
    /// Taken from the following GitHub project: https://github.com/dg9ngf/FieldLog/blob/master/LogSubmit/Unclassified/UI/SystemMenu.cs
    /// </remarks>
    public class SystemMenuHelper
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="SystemMenuHelper"/> class for the specified
        /// <see cref="Form"/>.
        /// </summary>
        /// <param name="form">The window for which the system menu is expanded.</param>
        public SystemMenuHelper(Form form)
        {
            this.form = form;
