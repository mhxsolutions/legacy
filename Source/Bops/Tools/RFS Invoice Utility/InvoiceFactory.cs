...
namespace RFS_Invoice_Utility
{
    public class InvoiceFactory
    {
         ...
         * several articles that gave me a method: create a new connection information object, then
         ...
         * method on the report object with the following hard-coded values at run time. It's ugly, 
         * but at least it prevents the report viewer from popping up and prompting the user for 
         * a password every single time.
         * 
