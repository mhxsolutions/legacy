                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:SqlDataSource
                                        ...
                                        SelectCommand="SELECT DISTINCT [DWS Rep Data].dbo.tbldestinationList.[Destination id], [DWS Rep Data].dbo.tbldestinationList.Destination + ': ' + [DWS Rep Data].dbo.tbldestinationList.City + ', ' + ISNULL([DWS Rep Data].dbo.tbldestinationList.State, '') AS Client FROM [MhxWeb_UserDetails] INNER JOIN [DWS Rep Data].dbo.tbldestinationList ON [MhxWeb_UserDetails].[Client Filter Destination Ref] = [DWS Rep Data].dbo.tbldestinationList.[Destination id] WHERE ([DWS Rep Data].dbo.tbldestinationList.[Company ID ref] = 9) ORDER BY Client"></asp:SqlDataSource>
