...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="contentDiv">
        <p>
            ...
            <asp:Calendar ID="Calendar2" runat="server" Width="350px" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="190px" NextPrevFormat="FullMonth">
                <DayHeaderStyle Font-Bold="True" Font-Size="8pt" />
                <NextPrevStyle Font-Bold="True" Font-Size="8pt" ForeColor="#333333" VerticalAlign="Bottom" />
                <OtherMonthDayStyle ForeColor="#999999" />
                <SelectedDayStyle BackColor="#333399" ForeColor="White" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT [Receiving Client Ref], [Client Name], City, [Product Profile Description], [Group Label 1], [Product Group 1], [Group Label 2], [Product Group 2], [Group Label 3], [Product Group 3], [Group Label 4], [Product Group 4], [Group Label 5], [Product Group 5], [Item ID], [Weight Label], Wt, Avg_Wt, Tons, [Unit Label], [Unit Count], [Count In Package], [Total Pcs], LnFt, Terminal, [Terminal Abr], [Recd Date], [Exit Date], [Ship Date], [Product Profile Ref], [Product Type] FROM [Inventory All received and shipped summary] WHERE ([Receiving Client Ref] = @Receiving_Client_Ref) AND ([Exit Date] &gt; @Exit_Date) AND ([Recd Date] &lt;= @Recd_Date)">
        <SelectParameters>
