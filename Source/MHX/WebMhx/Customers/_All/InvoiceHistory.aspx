<%@ Page Title="MHX | Invoice History" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="InvoiceHistory.aspx.cs" Inherits="Customers__All_InvoiceHistory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="InvoiceHistoryDatasource" AutoGenerateColumns="False" Width="98%">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Hide From Clients" VisibleIndex="2" Visible="False"></dx:GridViewDataTextColumn>
