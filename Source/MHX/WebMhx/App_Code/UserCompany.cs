...
public class UserCompany
{
    ...
    {
        string sqlText = "SELECT TOP 1 U.[Client Filter Destination Ref] AS DestinationId FROM [DWS No Rep Data].dbo.[MhxWeb_UserDetails] U WHERE U.[User Id]= @UserName";
        string connectionString = ConfigurationManager.ConnectionStrings["DWS No Rep DataConnectionString"].ConnectionString;
    ...
    public static string GetCompanyIdByUserName(string userName)
    {
        string sqlText = @"
            ...
            FROM [DWS No Rep Data].dbo.[MhxWeb_UserDetails] D
    ...
    {
        string sqlText = "DELETE [DWS No Rep Data].dbo.[MhxWeb_UserDetails] WHERE [User Id] = @UserName";
        string connectionString = ConfigurationManager.ConnectionStrings["DWS No Rep DataConnectionString"].ConnectionString;
    ...
    {
        string sqlText = @"IF NOT EXISTS(SELECT 1 FROM [DWS No Rep Data].dbo.[MhxWeb_UserDetails] U WHERE U.[User Id] = @UserName)
