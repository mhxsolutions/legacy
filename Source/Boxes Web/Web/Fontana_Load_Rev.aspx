<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Fontana_Load_Rev.aspx.vb" Inherits="Fontana_Load_Rev" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Fontana Load Rev</title>
</head>
<body>
    ...
    <div>
        ...
        <h3>
            Fontana Planned Load Revenue</h3>
        <br />
        ...
        <dx:ASPxGridView ID="ASPxGridView9" runat="server" AutoGenerateColumns="False" 
