<%@ Page Language="VB" AutoEventWireup="false" CodeFile="harbor_Loadouts.aspx.vb" Inherits="harbor_Loadouts" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Harbor Loadout</title>
</head>
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Origin Class load detail]">
        </asp:SqlDataSource>
    
    </div>
    <dx:ASPxGridViewExporter ID="GridViewExporter1" runat="server" 
        FileName="Harbor Loads" GridViewID="ASPxGridView1">
    </dx:ASPxGridViewExporter>
    </form>
    <p>
        Loads with LogOut Date and Origins with Classification</p>
</body>
</html>
