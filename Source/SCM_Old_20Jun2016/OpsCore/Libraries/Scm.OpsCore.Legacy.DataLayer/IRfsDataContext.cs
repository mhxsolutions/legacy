...
namespace Scm.OpsCore.Legacy.DataLayer
{
    ...
    public interface IRfsDataContext
    {
        ...
        IList<BopsDestination> GetDestinations();
        /// <summary>
        ...
        /// <param name="endDate">The end date.</param>
        /// <returns>A list of invoices if successful, null otherwise.</returns>
        IList<BopsRfsInvoice> GetInvoicesByDates(DateTime beginDate, DateTime endDate);
        /// <summary>
        /// Gets all RFS stakeholders.
        /// </summary>
        /// <returns>A list of stakeholders if successful, null otherwise.</returns>
        IList<BopsRfsStakeholder> GetStakeholders();
        /// <summary>
        ...
        IList<BopsRfsServiceCalculationResult> GetServiceCalculationResultsByDatesAndBillingStatus(DateTime beginDate, DateTime endDate, RfsBillingStatus billingStatus);
        /// <summary>
        ...
        IList<BopsRfsLocation> GetLocations();
        ...
        IList<BopsScan> GetScansByLoadReferencesTypeSignedAndReject(string[] loadRefs, int docType, bool isSigned, int rejectRef);
