...
<body>
    <form id="form1" runat="server" defaultfocus="Login1">
        ...
        <div id="centered" align="center">
            <asp:Image ID="LogoImage" runat="server" ImageUrl="~/Images/SCM-Website-Header.png" AlternateText="Logo" />
            <p></p>
            ...
            <asp:Login ID="_HydraLogin" runat="server" BackColor="#EEEEEE" BorderColor="#888888" BorderPadding="4"
                ...
                <TitleTextStyle BackColor="#F3951C" Font-Bold="True" Font-Size="0.9em" ForeColor="White" />
            ...
            If you are a SCM client and would like access to our tools,
            <br />
            please click <a href="mailto:shelly@sc-man?subject=New SCM web Account">here</a> to email Shelly Anthony.<br />
            <br />
            If you are experiencing technical problems with an existing account,<br />
            please click <a href="mailto:jorge@sc-man.com?subject=SCM web Service Issue">here</a> to email Jorge Sandoval.<br />
            <br />
        </div>
