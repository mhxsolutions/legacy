...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="UsersDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
        SelectCommand="SELECT [SCM User Details].[User Id], [DWS Rep Data].dbo.tbldestinationList.Destination + ': ' + [DWS Rep Data].dbo.tbldestinationList.City + ', ' + ISNULL([DWS Rep Data].dbo.tbldestinationList.State, '') AS Client FROM [SCM User Details] INNER JOIN [DWS Rep Data].dbo.tbldestinationList ON [SCM User Details].[Client Filter Destination Ref] = [DWS Rep Data].dbo.tbldestinationList.[Destination id] ORDER BY [SCM User Details].[User Id]"
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <asp:SqlDataSource ID="StakeholderList" runat="server" ConnectionString="<%$ ConnectionStrings:DWS Rep DataConnectionString %>"
                    SelectCommand="SELECT [Destination id], Destination + ': ' + City + ', ' + ISNULL(State, '') AS Destination, [Company ID ref] FROM tbldestinationList WHERE ([Parent Ref] = [Destination id]) AND ([Company ID ref] = 8)">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
