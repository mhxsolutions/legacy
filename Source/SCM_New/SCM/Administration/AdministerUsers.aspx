<%@ Page Title="SCM | Administer Users" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="AdministerUsers.aspx.cs" Inherits="Web.Administration.AdministerUsers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="contentDiv">
        <dx:ASPxGridView ID="grdUsers" runat="server" DataSourceID="UsersDataSource" KeyFieldName="UserId" ClientInstanceName="grdUsers" Width="100%"
        ...
        <asp:SqlDataSource ID="UsersDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
            SelectCommand="SELECT [SCM User Details].[User Id] as UserId, [aspnetdb].dbo.GetRoleName([SCM User Details].[User Id], 'ScmWeb') as UserRole, '' as Password, '' as Change, [Client Filter Destination Ref] as DestinationId, [DWS Rep Data].dbo.tbldestinationList.Destination + ': ' + [DWS Rep Data].dbo.tbldestinationList.City + ', ' + ISNULL([DWS Rep Data].dbo.tbldestinationList.State, '') AS Client FROM [SCM User Details] INNER JOIN [DWS Rep Data].dbo.tbldestinationList ON [SCM User Details].[Client Filter Destination Ref] = [DWS Rep Data].dbo.tbldestinationList.[Destination id] ORDER BY [SCM User Details].[User Id]"
