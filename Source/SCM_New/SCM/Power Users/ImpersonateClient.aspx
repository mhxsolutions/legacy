<%@ Page Title="SCM | Impersonate Client" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ImpersonateClient.aspx.cs"
        ...
        site privileges, but it will affect the data displayed on the various reports.
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:SqlDataSource
                                        ...
                                        SelectCommand="SELECT DISTINCT [DWS Rep Data].dbo.tbldestinationList.[Destination id], [DWS Rep Data].dbo.tbldestinationList.Destination + ': ' + [DWS Rep Data].dbo.tbldestinationList.City + ', ' + ISNULL([DWS Rep Data].dbo.tbldestinationList.State, '') AS Client FROM [SCM User Details] INNER JOIN [DWS Rep Data].dbo.tbldestinationList ON [SCM User Details].[Client Filter Destination Ref] = [DWS Rep Data].dbo.tbldestinationList.[Destination id] ORDER BY Client"></asp:SqlDataSource>
                    ...
                    <asp:Panel ID="ClearImpersonatePanel" runat="server">
                        ...
                        <% if (Session["CONTEXT_IMPERSONATE"] != null)
                           {%>
                        <p>
                            You are currently impersonating: <b><% Response.Write(Session["CONTEXT_IMPERSONATE"].ToString()); %></b>. <br /><br />To clear the impersonation, click
            the button below.
                        </p>
                        <% }
                           else
