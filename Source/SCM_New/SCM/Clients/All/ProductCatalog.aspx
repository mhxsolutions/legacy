<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductCatalog.aspx.cs" Inherits="Web.Clients.All.ProductCatalog" %>
...
<body>
    <form id="form1" runat="server">
        <h2>Master Product Catalog</h2>
        <div class="contentDiv">
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="Item Template ID">
                <Columns>
