<%@ Page Language="C#" MasterPageFile="~/TubularTransport.master" AutoEventWireup="true" CodeFile="AdministerUsers.aspx.cs" Inherits="Administration_AdministerUsers" 
    Title="Tubular Transport | Administer Users" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1"
        ...
        DataKeyNames="User Id" DataSourceID="TTLUsersDataSource" ForeColor="#333333"
        GridLines="None">
    ...
    <asp:SqlDataSource ID="TTLUsersDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
        SelectCommand="SELECT [TTL User Details].[User Id], [DWS Rep Data].dbo.tbldestinationList.Destination + ': ' + [DWS Rep Data].dbo.tbldestinationList.City + ', ' + ISNULL([DWS Rep Data].dbo.tbldestinationList.State, '') AS Client FROM [TTL User Details] INNER JOIN [DWS Rep Data].dbo.tbldestinationList ON [TTL User Details].[Client Filter Destination Ref] = [DWS Rep Data].dbo.tbldestinationList.[Destination id] ORDER BY [TTL User Details].[User Id]"
        InsertCommand="INSERT INTO [TTL User Details] ([User Id], [Client Filter Destination Ref]) VALUES (@UserId, @Client)">
        <InsertParameters>
