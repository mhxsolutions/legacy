<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportTodayDr.aspx.cs" Inherits="Mobile_ReportTodayDr" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Harbor Web | Report Today</title>
</head>
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="BLID" HeaderText="BL" SortExpression="BLID">
        ...
        <asp:SqlDataSource ID="DrDatasource" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep Data ConnectionString %>"
            SelectCommand="SELECT DRID, Count, Weight, [Last Update Time], Finalized, [Gate Pass], [Load Ref], Tractor, [PMBOL Ref] AS BLID FROM [Hops DR Entry] WHERE ([Last Update Time] >= CONVERT (VARCHAR(10), GETDATE(), 101))"></asp:SqlDataSource>
        <p>
