<%@ Page Language="C#" MasterPageFile="~/CustomerService.master" AutoEventWireup="true" Inherits="Customers__Thoro_Dwell" Title="Dwell" Codebehind="ThoroDwell.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    Year:<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Ded- Thoro" Name="Fleet" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
