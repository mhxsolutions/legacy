<%@ Page Language="C#" MasterPageFile="~/CustomerService.master" AutoEventWireup="true" Inherits="Customers__Product_Consigned_Transactions" 
    Title="Consigned Product Transactions" CodeBehind="Product_Consigned_Transactions_Lookup.aspx.cs" 
    CodeFile="Product_Consigned_Transactions_Lookup.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3>
        Product Transactions for Consigned Inventory</h3>
    <br />
    &nbsp;<br />
    &nbsp;<asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Client" HeaderText="Inventory" SortExpression="Client" />
            ...
            <asp:BoundField DataField="PDF of Load" HeaderText="Out-Load" HtmlEncode="False" SortExpression="BOL" >
                <ItemStyle Wrap="False" />
            </asp:BoundField>
            <asp:HyperLinkField DataNavigateUrlFields="BOL" DataNavigateUrlFormatString="tally_detail.aspx?Load_ref={0}"
                DataTextField="BOL" HeaderText="Tally" >
                <ItemStyle Wrap="False" />
            </asp:HyperLinkField>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
        SelectCommand="SELECT Terminal, Date, Profile, Type, Carrier, Description, [Product Group 1] AS Product_Group_1, [Product Group 2] AS Product_Group_2, [Product Group 3] AS Product_Group_3, [Item Ct] AS Item_Ct, Pounds, [Linear Ft] AS Linear_Ft, Receiver, BOL, [PDF of Load], [Client ref], Client FROM [COPS Transactions Log by carrier for web] WHERE (Profile = @Profile) AND ([Product Group 1] = @PG1) AND ([Client ref] = @Parent_ref) ORDER BY Terminal, Date">
        <SelectParameters>
            <asp:QueryStringParameter Name="Profile" QueryStringField="Profile" Type="String" />
            <asp:QueryStringParameter Name="PG1" QueryStringField="PG1" Type="String" />
            <asp:QueryStringParameter Name="Parent_ref" QueryStringField="Parent_ref" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
