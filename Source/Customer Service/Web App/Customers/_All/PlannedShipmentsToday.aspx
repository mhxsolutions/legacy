<%@ Page Language="C#" MasterPageFile="~/CustomerService.master" AutoEventWireup="true" Inherits="Customers__All_PlannedShipmentsToday" 
    Title="BudwayDirect | Planned Deliveries" Codebehind="PlannedShipmentsToday.aspx.cs" CodeFile="PlannedShipmentsToday.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2>Planned Client Shipments</h2>
    ...
    <asp:SqlDataSource ID="PlannedDeliveriesDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
        SelectCommand="SELECT * FROM [COPSLoadPlan] WHERE ([Parent ref] = @Parent_ref) ORDER BY [Sch Arrive]">
        <SelectParameters>
