<%@ Page Language="C#" MasterPageFile="~/CustomerService.master" AutoEventWireup="true" Inherits="Customers_InboundShippingMap" 
    Title="BudwayDirect | Outbound Shipping Map" CodeBehind="InboundShippingMap.aspx.cs" CodeFile="InboundShippingMap.aspx.cs" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="MapObjectsGridview" runat="server" AutoGenerateColumns="False"
                    ...
                    <EmptyDataTemplate>
                        <asp:Label ID="EmptyMapLabel" runat="Server">No inbound shipping found to display on map.</asp:Label>
                    </EmptyDataTemplate>
                    <Columns>
