<%@ Page Language="C#" MasterPageFile="~/CustomerService.master" AutoEventWireup="true" Inherits="Customers__All_PlannedReceiverLoadHistory" 
    Title="BudwayDirect | Planned Load History" CodeBehind="PlannedReceiverLoadHistory.aspx.cs" CodeFile="PlannedReceiverLoadHistory.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2>
        Receiver Load History
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
        SelectCommand="SELECT [Load], [Plan Date], Origin, Action, Arrive, Stop, [Sch Arrive], [Final Destination], Shipper, [Shipper Ref], [PDF File], [Dest ref], [PDF File Name], age, [Receiver ref] FROM COPSLoadPlanHistory WHERE (age <= @age_sel) AND ([Receiver ref] = @Shipper_Ref) ORDER BY [Plan Date], [Load]">
        <SelectParameters>
