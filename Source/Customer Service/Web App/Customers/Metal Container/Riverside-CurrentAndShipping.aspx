...
<%@ Page Language="C#" MasterPageFile="~/CustomerService.master" AutoEventWireup="true" Inherits="Customers_Metal_Container_Riverside_CurrentAndShipping" 
    Title="BudwayDirect | Custom Reports | Metal Container Riverside - Current And Shipping" Codebehind="Riverside-CurrentAndShipping.aspx.cs" %>
    
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <h2>Metal Container Riverside - Pipeline</h2>
    ...
    <asp:SqlDataSource ID="_SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
        SelectCommand="SELECT * FROM [MCCR current and shipping]">
    </asp:SqlDataSource>
