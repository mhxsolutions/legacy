<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RailSummary.aspx.vb" Inherits="RailSummary" %>
...
<body>
    ...
    <div>
        ...
        <h3>
            TTL Rail Summary - <a href="default.aspx">home</a><br />
        </h3>
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Terminal" SortIndex="2" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Rail Summary by Year and Date TTL only]">
        </asp:SqlDataSource>
