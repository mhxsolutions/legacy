<%@ Page Title="UPA | Impersonate Client" Language="C#" MasterPageFile="~/UPA.master" AutoEventWireup="true" CodeBehind="ImpersonateClient.aspx.cs" 
        ...
        <table>
            <tr>
                ...
                <td valign="top">
                    ...
                    <asp:SqlDataSource
                        ID="UsersDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:UPA No Rep DataConnectionString %>"
                        SelectCommand="SELECT DISTINCT [UPA Rep Data].dbo.tbldestinationList.[Destination id], [UPA Rep Data].dbo.tbldestinationList.Destination + ': ' + [UPA Rep Data].dbo.tbldestinationList.City + ', ' + ISNULL([UPA Rep Data].dbo.tbldestinationList.State, '') AS Client FROM [UPA User Details] INNER JOIN [UPA Rep Data].dbo.tbldestinationList ON [UPA User Details].[Client Filter Destination Ref] = [UPA Rep Data].dbo.tbldestinationList.[Destination id] ORDER BY Client">
                    </asp:SqlDataSource>
