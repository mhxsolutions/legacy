<%@ Page Language="C#" MasterPageFile="~/UPA.master" AutoEventWireup="true" CodeBehind="ForgetPassword.aspx.cs" Inherits="Web.ForgetPassword"  Title="UPA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="contentDiv" style="text-align: center">
        ...
        <asp:PasswordRecovery ID="PasswordRecovery1" runat="server">
            <MailDefinition From="info@sc-man.com" Subject="UPA Forget Password" BodyFileName="EmailTemplates/PasswordRecover.txt" >
            </MailDefinition>
            <UserNameTemplate>
