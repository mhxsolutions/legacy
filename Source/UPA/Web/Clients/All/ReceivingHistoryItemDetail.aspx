<%@ Page Title="Receiving History" Language="C#" MasterPageFile="~/UPA.master" AutoEventWireup="true" CodeBehind="ReceivingHistoryItemDetail.aspx.cs" Inherits="Web.Clients.All.ReceivingHistoryItemDetail" %>
<%@ Register assembly="DevExpress.Web.v16.2, Version=16.2.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>Receiving History - Item Detail</h3>
    <p>
    ...
    <p>
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" KeyFieldName="Receiver ID" Theme="Office2010Blue">
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Serial #" FieldName="SerialNumber" VisibleIndex="30">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="PO #" FieldName="PONumber" VisibleIndex="31">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Heat #" FieldName="HeatNumber" VisibleIndex="32">
                </dx:GridViewDataTextColumn>
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UPA No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [UPAReceivingHistoryItemDetail] WHERE ([client] = @client)">
            <SelectParameters>
                <asp:SessionParameter Name="client" SessionField="context_clientID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
        <dx:ASPxGridViewExporter ID="GridViewExporter1" runat="server" FileName="Receiving History Item Detail" GridViewID="ASPxGridView1">
