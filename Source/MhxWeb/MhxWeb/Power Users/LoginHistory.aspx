...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="contentDiv">
        ...
        <dx:ASPxGridView ID="gvLoginHistory" runat="server" AutoGenerateColumns="false" DataSourceID="DataSource1" KeyFieldName="ID" Width="98%">
            ...
            <Columns>
                ...
                <dx:GridViewDataDateColumn FieldName="LoginDateTime" VisibleIndex="2" UnboundType="DateTime" PropertiesDateEdit-DisplayFormatString="G">
        ...
        <asp:SqlDataSource ID="DataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
            SelectCommand="SELECT * FROM LoginHistory WHERE LoginDateTime BETWEEN @StartDate AND (@EndDate + 1) AND UserRole = @UserRole AND ApplicationName = @AppName AND (UserName in (select [User Id] from dbo.[MhxWeb_UserDetails] where [Client Filter Destination Ref] = @ClientId)) ORDER BY LoginDateTime Desc">
            <SelectParameters>
