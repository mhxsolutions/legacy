...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="contentDiv">
        ...
        <asp:SqlDataSource ID="UsersDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
            SelectCommand="SELECT [Cops User Details].[User Id] as UserId, [aspnetdb].dbo.GetRoleName([Cops User Details].[User Id], 'CopsWeb') as UserRole, '' as Password, '' as Change, [Client Filter Destination Ref] as DestinationId, [DWS Rep Data].dbo.tbldestinationList.Destination + ': ' + [DWS Rep Data].dbo.tbldestinationList.City + ', ' + ISNULL([DWS Rep Data].dbo.tbldestinationList.State, '') AS Client FROM [Cops User Details] INNER JOIN [DWS Rep Data].dbo.tbldestinationList ON [Cops User Details].[Client Filter Destination Ref] = [DWS Rep Data].dbo.tbldestinationList.[Destination id] ORDER BY [Cops User Details].[User Id]"
            InsertCommand="INSERT INTO [Cops User Details] ([User Id], [Client Filter Destination Ref]) VALUES (@UserId, @Client)"
            UpdateCommand="UPDATE [Cops User Details] SET [Client Filter Destination Ref] = @Client WHERE [User Id] = @UserId"
            DeleteCommand="DELETE FROM [Cops User Details] WHERE [User Id]=@UserId">
            <InsertParameters>
