...
{
    public partial class ImpersonateClient : BasePage
    {
        ...
        protected void ImpersonateButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Power Users/ImpersonateClient.aspx");
        }

        protected void ClearImpersonateButton_Click(object sender, EventArgs e)
        {
            Session.Remove(ContextImpersonate);
            Session[ContextClientId] = UserCompany.GetDestinationIdByUserName(User.Identity.Name); //BudwayDestinationId;
            Response.Redirect("~/Power Users/ImpersonateClient.aspx");
        }
    }
}