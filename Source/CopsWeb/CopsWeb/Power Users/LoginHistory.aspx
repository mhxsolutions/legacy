...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="contentDiv">
        ...
        <asp:SqlDataSource ID="DataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
            SelectCommand="SELECT * FROM LoginHistory WHERE LoginDateTime BETWEEN @StartDate AND (@EndDate + 1) AND UserRole = @UserRole AND ApplicationName = @AppName AND (UserName in (select [User Id] from dbo.[Cops User Details] where [Client Filter Destination Ref] = @ClientId)) ORDER BY LoginDateTime Desc">
            <SelectParameters>
