...
<head runat="server">
    ...
    <style>
        ...
        .body {
            ...
            width: auto;
            height: auto;
            background-image: url(Content/Images/BudwayWithCrane.jpg);
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="logoContent">
            <img src="Content/Images/StipLineBudwayLogo.png" alt="BUDWAY" class="responsiveImg" />
        </div>
                ...
                <div class="login">
                    ...
                    <div class="info">
                        ...
                        <p style="text-align: center">
                            ...
                            <br />
                            SC Data Solutions: 909.641.5461
                        </p>
                    </div>
                </div>
            </LayoutTemplate>
