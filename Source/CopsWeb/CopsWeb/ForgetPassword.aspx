<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ForgetPassword.aspx.cs" Inherits="All_ForgetPassword" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="contentDiv" style="text-align: center">
        ...
        <asp:PasswordRecovery ID="PasswordRecovery1" runat="server">
            <MailDefinition From="info@sc-man.com" Subject="CopsWeb Forget Password" BodyFileName="EmailTemplates/PasswordRecover.txt" >
            </MailDefinition>
            <UserNameTemplate>
