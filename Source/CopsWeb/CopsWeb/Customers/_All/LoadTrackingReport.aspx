<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="LoadTrackingReport.aspx.cs"
...
<asp:Content ID="LoadContentsTable" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="contentDiv">
        ...
        <table cellpadding="4" border="1">
            <tr>
                <td style="width: 200px">Load Reference Number:</td>
                <td style="width: 300px">
                    <asp:Label ID="LoadReferenceNumberLabel" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 200px">Origin:</td>
                <td style="width: 300px">
            ...
            <tr>
                <td style="width: 200px">Scheduled Arrive at Client:</td>
                <td style="width: 300px">
                    <asp:Label ID="ArrivalLabel" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 200px">Scheduled Depart Budway:</td>
                <td style="width: 300px">
