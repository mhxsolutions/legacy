...
<title>Audit Will Calls</title>
</head>

<body>

<form id="form1" runat="server">
	<h3>Audit Will Calls</h3>
	<p>
	<asp:GridView id="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Load" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
		...
		<Columns>
			...
			<asp:checkboxfield DataField="LogOut" HeaderText="LogOut" SortExpression="LogOut">
			</asp:checkboxfield>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [vAudit Will Calls]">
	</asp:SqlDataSource>
	</p>
</form>
