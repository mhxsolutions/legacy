...
<title>Today's Plan Summary</title>
</head>

<body>

<form id="form1" runat="server">
	<h3>Today's Planed Delivery Summary</h3>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [TodaysLoadSummary]">
	</asp:SqlDataSource>
</form>
