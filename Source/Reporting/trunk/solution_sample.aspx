...
<form id="form1" runat="server">
	...
	<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT DISTINCT [Date] FROM [OR dispatch solution] ORDER BY [Date] DESC">
	</asp:SqlDataSource>
	</p>
	<p><a href="demand_sample.aspx">demand page&nbsp;</a></p>
	<asp:GridView id="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
		...
		<Columns>
			...
			<asp:boundfield DataField="Driver Ref" HeaderText="Driver Ref" SortExpression="Driver Ref">
			</asp:boundfield>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [OR dispatch solution] WHERE ([Date] = @Date) ORDER BY [Driver Ref], [Order]">
		<SelectParameters>
