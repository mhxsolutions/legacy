...
<title>Raritan - Receivers</title>
</head>

<body>

<form id="form1" runat="server">
	<h3>Raritan - Receivers</h3>
	...
	<p>
	<asp:GridView id="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Receiver ID,Client Name" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
		<RowStyle BackColor="#EFF3FB" />
		<Columns>
			<asp:boundfield DataField="Receiver ID" HeaderText="Receiver ID" ReadOnly="True" SortExpression="Receiver ID">
			</asp:boundfield>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [Raritan Receiver Ct and Wt] WHERE (([Date Received] &gt;= @Date_Received) AND ([Date Received] &lt;= @Date_Received2)) ORDER BY [Receiver ID] DESC">
		<SelectParameters>
...
<p>No pre-receivers included. (Receiver must be locked.)</p>
