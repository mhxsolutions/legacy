...
<body>
    ...
    <div>
    <h1>Active Harbor Projects By Terminal</h1>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
            <RowStyle BackColor="#EFF3FB" />
            <Columns>
                <asp:BoundField DataField="LFD" DataFormatString="{0:MM/dd/yy}" HeaderText="LFD"
                    SortExpression="LFD" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
            SelectCommand="SELECT * FROM webHarborDemand ORDER BY Origin ASC,LFD ASC,Client ASC,Vessel ASC">
        </asp:SqlDataSource>
    </div>
    </form>
</body>
