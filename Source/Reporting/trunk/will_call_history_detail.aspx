...
<title>Will Call History Detail</title>
</head>

<body>

<form id="form1" runat="server">
	<h3>Will Call History Detail</h3>
	<p>
	...
	<asp:GridView id="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
		...
		<Columns>
			...
			<asp:boundfield DataField="LogOutTime" DataFormatString="{0:t}" HeaderText="LogOutTime" SortExpression="LogOutTime">
			</asp:boundfield>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [Will call history by fleet detail] WHERE ([LogOutDate] = @LogOutDate) ORDER BY [Fleet], [LogOutTime], [Client Name]">
		<SelectParameters>
