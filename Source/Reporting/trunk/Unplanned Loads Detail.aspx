...
<title>Unplanned Loads Detail</title>
</head>

<body>

<form id="form1" runat="server">
	<h3>Unplanned Loads Detail</h3>
	<p>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [webUnplannedLoads] ORDER BY [LoadDate], [Client]">
	</asp:SqlDataSource>
	</p>
</form>
