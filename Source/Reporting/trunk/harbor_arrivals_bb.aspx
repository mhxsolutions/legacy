...
<form id="form1" runat="server">
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT DISTINCT [Date] FROM [vSYSharborArrivalsBB] ORDER BY [Date] DESC">
	</asp:SqlDataSource>
	</p>
	<p>&nbsp;</p>
	...
	<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [vSYSharborArrivalsBB] WHERE ([Date] = @Date) ORDER BY [Load @], [Arrive @]">
		<SelectParameters>
