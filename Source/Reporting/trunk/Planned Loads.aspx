...
<form id="form1" runat="server">
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [webPlannerToday] ORDER BY [Scheduled Delivery]">
	</asp:SqlDataSource>
	</p>
</form>
