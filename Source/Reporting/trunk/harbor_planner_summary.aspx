...
<title>Harbor Planner Summary</title>
</head>

<body>

<form id="form1" runat="server">
	<h3>Harbor Planner Summary</h3>
	<p><a href="h-sch.aspx">show detail</a></p>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT DISTINCT [Date] FROM [vsysHarborPlanSummary] ORDER BY [Date]">
	</asp:SqlDataSource>
	</p>
	...
	<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [vsysHarborPlanSummary] WHERE ([Date] = @Date) ORDER BY [Load @], [Dest]">
		<SelectParameters>
