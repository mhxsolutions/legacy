...
<title>Rail Summary by Month</title>
</head>

<body>

<form id="form1" runat="server">
	<h3>Rail Summary by Month</h3>
	<p>&nbsp;</p>
	...
	<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DWS Rep DataConnectionString %>" SelectCommand="SELECT DISTINCT [Month] FROM [Rail Summary by year and month] ORDER BY [Month] DESC">
	</asp:SqlDataSource>
	...
	<asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DWS Rep DataConnectionString %>" SelectCommand="SELECT [Client], [Commodity], [Carrier], [Count] FROM [Rail Summary by year and month] WHERE (([Year] = @Year) AND ([Month] = @Month)) ORDER BY [Client], [Commodity]">
		<SelectParameters>
