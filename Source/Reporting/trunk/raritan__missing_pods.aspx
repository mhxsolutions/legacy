...
<title>Raritan - Missing PODs</title>
</head>

<body>

<form id="form1" runat="server">
	<h3>Raritan - Missing PODs</h3>
	<p>Load shipped. No POD on file.</p>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT [LoadDate], [Destination], [Load] FROM [Raritan missing PODs] ORDER BY [LoadDate], [Destination], [Load]">
	</asp:SqlDataSource>
</form>
