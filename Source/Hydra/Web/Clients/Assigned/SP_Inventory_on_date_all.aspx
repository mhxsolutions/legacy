<%@ Page Title="SP Inventory" Language="C#" MasterPageFile="~/Hydra.master" AutoEventWireup="true" CodeBehind="SP_Inventory_on_date_all.aspx.cs" Inherits="Web.Clients.Assigned.SP_Inventory_on_date_all" %>
<%@ Register assembly="DevExpress.Web.v16.2, Version=16.2.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<%@ Register Src="~/Controls/SaveLayout.ascx" TagPrefix="uc1" TagName="SaveLayout" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>SB Fromatted Inventory</h3>
    ...
    <p>
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" Theme="Office2003Olive">
            ...
            <Columns>
                ...
                <dx:GridViewDataDateColumn FieldName="Date Received" ReadOnly="True" VisibleIndex="9">
                </dx:GridViewDataDateColumn>
                <dx:GridViewDataTextColumn FieldName="Release#" SortIndex="4" SortOrder="Ascending" VisibleIndex="3">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Grade" SortIndex="5" SortOrder="Ascending" VisibleIndex="4">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="#Bales" VisibleIndex="5">
                    <PropertiesTextEdit DisplayFormatString="n0">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Wt Lb" VisibleIndex="6">
                    <PropertiesTextEdit DisplayFormatString="n0">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Avg_Wt" VisibleIndex="7">
                ...
                <dx:GridViewDataTextColumn FieldName="Client" GroupIndex="1" SortIndex="1" SortOrder="Ascending" VisibleIndex="13">
                    <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                    <SettingsHeaderFilter Mode="CheckedList">
                    </SettingsHeaderFilter>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Product Type" GroupIndex="0" SortIndex="0" SortOrder="Ascending" VisibleIndex="14" Caption="Product">
                    <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                    <SettingsHeaderFilter Mode="CheckedList">
                    </SettingsHeaderFilter>
                </dx:GridViewDataTextColumn>
            ...
            <TotalSummary>
                ...
                <dx:ASPxSummaryItem FieldName="Tons" ShowInColumn="Tons" SummaryType="Sum" DisplayFormat="Tons={0:n1}" />
            ...
            <GroupSummary>
                ...
                <dx:ASPxSummaryItem FieldName="Tons" ShowInGroupFooterColumn="Tons" SummaryType="Sum" DisplayFormat="Tons={0:n1}" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT [Receiving Client Ref], Client, Profile, [Vendor/Supplier], [Date Received], Release#, Grade, [#Bales], [Wt Lb], Avg_Wt, Tons, [Exit Date], [Ship Date], Terminal, [Product Type], [Company ID ref] FROM [Hydra Inventory All rcd and ship summary for scrap paper] WHERE ([Date Received] &lt;= @Date_Received) AND ([Exit Date] &gt; @Exit_Date) AND ([Company ID ref] = 3)">
            <SelectParameters>
