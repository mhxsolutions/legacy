<%@ Page Title="Consigned Inventory" Language="C#" MasterPageFile="~/Hydra.master" AutoEventWireup="true" CodeBehind="CB_Inventory_on_date_consigned.aspx.cs" Inherits="Web.Clients.Assigned.CB_Inventory_on_date_consigned" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" Theme="Office2003Olive" Width="98%">
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Profile" FieldName="Product Profile Description" GroupIndex="1" SortIndex="1" SortOrder="Ascending" VisibleIndex="2">
                    <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                    <SettingsHeaderFilter Mode="CheckedList">
                    </SettingsHeaderFilter>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Description" FieldName="Product Group 1" GroupIndex="2" SortIndex="2" SortOrder="Ascending" VisibleIndex="3">
                    <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                    <SettingsHeaderFilter Mode="CheckedList">
                    </SettingsHeaderFilter>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="PO#" FieldName="Product Group 3" SortIndex="4" SortOrder="Ascending" VisibleIndex="8">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn FieldName="Width" GroupIndex="3" ReadOnly="True" SortIndex="3" SortOrder="Ascending" VisibleIndex="5">
                    <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                    <SettingsHeaderFilter Mode="CheckedList">
                    </SettingsHeaderFilter>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Vendor" FieldName="Client Name" GroupIndex="0" SortIndex="0" SortOrder="Ascending" VisibleIndex="1">
                ...
                <dx:GridViewDataTextColumn Caption="Damage" FieldName="Damage Comments" VisibleIndex="15">
                </dx:GridViewDataTextColumn>
