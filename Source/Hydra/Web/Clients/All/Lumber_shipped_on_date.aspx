<%@ Page Title="Shipping History" Language="C#" MasterPageFile="~/Hydra.master" AutoEventWireup="true" CodeBehind="Lumber_shipped_on_date.aspx.cs" Inherits="Web.Clients.All.Lumber_shipped_on_date" %>
    ...
    <p>
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" KeyFieldName="BOL" Theme="Office2003Olive">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="BOL" ReadOnly="True" SortIndex="2" SortOrder="Ascending" VisibleIndex="3">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn FieldName="Product Code" VisibleIndex="7" SortIndex="3" SortOrder="Ascending">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn Caption="Type" FieldName="Unit Label" VisibleIndex="17">
                </dx:GridViewDataTextColumn>
        ...
        <dx:ASPxGridViewExporter ID="GridViewExporter1" runat="server" FileName="Shipping History" GridViewID="ASPxGridView1" BottomMargin="50" LeftMargin="50" Landscape="True" RightMargin="50" TopMargin="50">
        </dx:ASPxGridViewExporter>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [Hydra Shipping History for Lumber] WHERE (([R_Cleint_Ref] = @R_Cleint_Ref) AND ([Shipment Date] &gt;= @Shipment_Date) AND ([Shipment Date] &lt;= @Shipment_Date2))">
            <SelectParameters>
