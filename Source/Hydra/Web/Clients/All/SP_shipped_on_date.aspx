<%@ Page Title="Shipping" Language="C#" MasterPageFile="~/Hydra.master" AutoEventWireup="true" CodeBehind="SP_shipped_on_date.aspx.cs" Inherits="Web.Clients.All.SP_shipped_on_date" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" KeyFieldName="BOL" Theme="Office2003Olive">
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="Profile" GroupIndex="0" SortIndex="0" SortOrder="Ascending" VisibleIndex="2">
            <Settings AllowHeaderFilter="True" />
            <SettingsHeaderFilter Mode="CheckedList">
            </SettingsHeaderFilter>
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="BOL" ReadOnly="True" VisibleIndex="4" SortIndex="2" SortOrder="Ascending">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="Load Type" SortIndex="3" SortOrder="Ascending" VisibleIndex="5">
        </dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataDateColumn FieldName="Shipment Date" SortIndex="1" SortOrder="Ascending" VisibleIndex="3" Caption="Ship Date">
        ...
        <dx:GridViewDataTextColumn Caption="Carrier" FieldName="Equipment Reference" VisibleIndex="6">
        </dx:GridViewDataTextColumn>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>" SelectCommand="SELECT * FROM [Hydra Shipping History for scrap paper] WHERE (([Shipment Date] &gt;= @Shipment_Date) AND ([Shipment Date] &lt;= @Shipment_Date2) AND ([R_Cleint_Ref] = @R_Cleint_Ref))">
    <SelectParameters>
        ...
        <asp:SessionParameter DefaultValue="" Name="R_Cleint_Ref" SessionField="CONTEXT_CLIENTID" Type="Int32" />
    </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
