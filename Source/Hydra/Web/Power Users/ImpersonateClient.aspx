<%@ Page Title="Hydra | Impersonate Client" Language="C#" MasterPageFile="~/Hydra.master" AutoEventWireup="true" CodeBehind="ImpersonateClient.aspx.cs" 
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <asp:SqlDataSource
                        ...
                        SelectCommand="SELECT DISTINCT [DWS Rep Data].dbo.tbldestinationList.[Destination id], [DWS Rep Data].dbo.tbldestinationList.Destination + ': ' + [DWS Rep Data].dbo.tbldestinationList.City + ', ' + ISNULL([DWS Rep Data].dbo.tbldestinationList.State, '') AS Client FROM [Hydra User Details] INNER JOIN [DWS Rep Data].dbo.tbldestinationList ON [Hydra User Details].[Client Filter Destination Ref] = [DWS Rep Data].dbo.tbldestinationList.[Destination id] ORDER BY Client">
                    </asp:SqlDataSource>
