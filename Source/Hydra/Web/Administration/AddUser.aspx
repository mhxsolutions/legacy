<%@ Page Title="" Language="C#" MasterPageFile="~/Hydra.master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="Web.Administration.AddUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ObjectDataSource ID="odsCompany" runat="server" TypeName="UserData" SelectMethod="GetCompanyList">
        <SelectParameters>
    ...
    <asp:ObjectDataSource ID="odsClients" runat="server" TypeName="UserData" SelectMethod="GetClientListByCompany">
        <SelectParameters>
