...
<body>
    <form id="form1" runat="server" defaultfocus="Login1">
        ...
        <div id="centered" align="center">
            <asp:Image ID="LogoImage" runat="server" ImageUrl="~/Images/Hydra-Website-Header-small.jpg" AlternateText="Logo" Height="192px" Width="345px" />
            <p></p>
            ...
            <p style="text-align: center">
                ...
                <a href="mailto:info@sc-man.com">Contact us</a> for access or support.<br />
                SCM 909.641.5461<br />
        </div>
