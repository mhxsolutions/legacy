<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fldcat.aspx.cs" Inherits="fldcat" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>FLD Category Totals</title>
</head>
<body>
    ...
    <div><span style="color: #0000ff; text-decoration: underline"></span>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DWS No Rep DataConnectionString %>"
            SelectCommand="SELECT [FLD Date], [FLD Category], Goal, Actual, [FLD Category Index] FROM [FLD1 Category totals] WHERE ([FLD Date] = @FLD_Date) ORDER BY [FLD Category Index] DESC">
            <SelectParameters>
